<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px; height: 100vh">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <x-admin.sidebar-item route="admin.home" prefix="admin" icon="speedometer2" label="Home" />
        <x-admin.sidebar-item route="admin.user.index" prefix="admin/user" icon="people" label="Users" />
        ...
        @endphp
        <x-admin.sidebar-item route="admin.membership-plan.index" prefix="admin/membership-plan" icon="cash" 
        ...
        @endphp            
        <x-admin.sidebar-item route="admin.club.index" prefix="admin/club" icon="mic-fill" label="Club" 
        ...
        @endphp
        <x-admin.sidebar-item route="admin.award.index" prefix="admin/award" icon="award" label="Awards" 
